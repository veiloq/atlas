...
func TestCLI_Version(t *testing.T) {
	tests := []struct {
		...
		{
			name: "dev mode",
			cmd: exec.Command("go", "run", "github.com/veiloq/atlas/cmd/atlas",
				"version",
			),
		...
		},
		{
			...
			cmd: exec.Command("go", "run",
				"-ldflags",
				"-X github.com/veiloq/atlas/cmd/atlas/internal/cmdapi.version=v1.2.3",
				"github.com/veiloq/atlas/cmd/atlas",
				"version",
			),
		...
		},
		{
			...
			cmd: exec.Command("go", "run",
				"-ldflags",
				"-X github.com/veiloq/atlas/cmd/atlas/internal/cmdapi.version=v0.3.0-6539f2704b5d-canary",
				"github.com/veiloq/atlas/cmd/atlas",
				"version",
			),
		...
		},
		{
			...
			cmd: exec.Command("go", "run",
				"-ldflags",
				"-X github.com/veiloq/atlas/cmd/atlas/internal/cmdapi.flavor=flavor",
				"github.com/veiloq/atlas/cmd/atlas",
				"version",
			),
