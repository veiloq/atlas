...
var (
	...
	// "-X 'github.com/veiloq/atlas/cmd/atlas/internal/cmdapi.flavor=community'"
	flavor string

	// version holds Atlas version. When built with cloud packages should be set by build flag, e.g.
	// "-X 'github.com/veiloq/atlas/cmd/atlas/internal/cmdapi.version=v0.1.2'"
	version string
	...
	// "-X 'github.com/veiloq/atlas/cmd/atlas/internal/cmdapi.license=${license}'"
	license = `LICENSE
