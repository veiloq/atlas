	...
	tests := []struct {
		...
		},
		{
			...
			cmd: exec.Command("go", "run",
				"-ldflags",
				"-X github.com/veiloq/atlas/pkg/cmdapi.version=v1.2.3",
		...
		},
		{
			...
			cmd: exec.Command("go", "run",
				"-ldflags",
				"-X github.com/veiloq/atlas/pkg/cmdapi.version=v0.3.0-6539f2704b5d-canary",
				"github.com/veiloq/atlas/cmd/atlas",
				"version",
			),
		...
		},
		{
			...
			cmd: exec.Command("go", "run",
				"-ldflags",
				"-X github.com/veiloq/atlas/pkg/cmdapi.flavor=flavor",
				"github.com/veiloq/atlas/cmd/atlas",
				"version",
			),
