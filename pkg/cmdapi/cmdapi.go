...
import (
	...
	"github.com/veiloq/atlas/pkg/cmdext"
...
var (
	...
	// "-X 'github.com/veiloq/atlas/pkg/cmdapi.flavor=community'"
	flavor string

	// version holds Atlas version. When built with cloud packages should be set by build flag, e.g.
	// "-X 'github.com/veiloq/atlas/pkg/cmdapi.version=v0.1.2'"
	version string
	...
	// "-X 'github.com/veiloq/atlas/pkg/cmdapi.license=${license}'"
	license = `LICENSE
