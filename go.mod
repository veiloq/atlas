module github.com/veiloq/atlas
...
require (
	...
	github.com/stretchr/testify v1.9.0 // Updated from v1.8.2
	...
	golang.org/x/mod v0.24.0 // Updated from v0.17.0
...
require ariga.io/atlas v0.31.1-0.20250212144724-069be8033e83
